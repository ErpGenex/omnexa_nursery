...
from omnexa_nursery.nurs_gap_register import get_gap_status
from omnexa_nursery.nurs_global_benchmark import get_global_nurs_score

@frappe.whitelist()
def export_nurs_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_NURSERY_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_nurs_score(), get_gap_status()
